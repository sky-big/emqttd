...
%% Persistent Session
%% 持续性的emqttd_session，客户端断开连接后不会删除该session
...
%% Transient Session
%% 临时的eqmttd_session,客户端断开连接则将该session删除掉
